      		...
      		<table border="1" width=100%> 
      			<tr><td>书名</td><td>作者</td><td>商品价格</td><td width="5%">数量</td><td>操作</td></tr>		       
       			    <c:forEach var="bk" items="${shopBooks}">		
       				    <tr><td>${bk.bname}</td><td>${bk.author}</td><td>${bk.price}</td><td ><input type="text"  name="${bk.isbn}" value="1" /></td><td><a href="<%=basePath%>user/ShopcarRemoveSvl?isbn=${bk.isbn}">移除</a></td></tr>    
					 </c:forEach>      			
    		</table>
      	</td>
      </tr>
